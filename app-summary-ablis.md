...
<option value="6">Review Required</option>
    ...
    <td class="status-waiting">SASQUATCH CAFE</td>
    <td class="">
        <span>
	...
	<tfoot>
		<tr>
			<td><span class="fa fa-arrow-circle-right" style="color: #4f8fe6; font-size: 175%; float: left; margin-right: 8px;"></span> <p><strong>Next step</strong></p></td>
