...
<form action="/registration/companydetails?appId=2694" enctype="multipart/form-data" id="sobrsform" method="post">    <div style="display: none">
        ...
        <input id="__c__ApplicationId" name="__c__ApplicationId" type="hidden" value="URA7S4HXOvx8IaDRFmMyTA==">
...
<div class="manual-address" style="display: none">
    ...
    <div class="grid-row">
        <div class="col4">
            <label class="input-right" for="Associates_PersonAssociate_ResidentialAddress_AddressLine1">Address line 1</label>
        </div>
        <div class="col8 last">
            <input id="Associates_PersonAssociate_ResidentialAddress_AddressLine1" name="Associates.PersonAssociate.ResidentialAddress.AddressLine1" type="text" value=""> 
    ...
    <div class="grid-row">
        <div class="col4">
            <label class="input-right" for="Associates_PersonAssociate_ResidentialAddress_AddressLine2">Address line 2 <span class="field-note optional">(optional)</span></label>
        </div>
        <div class="col8 last">
            <input id="Associates_PersonAssociate_ResidentialAddress_AddressLine2" name="Associates.PersonAssociate.ResidentialAddress.AddressLine2" type="text" value=""> 
    ...
    <div class="grid-row address-international" style="display: none">
        <div class="col4">
            <label class="input-right" for="Associates_PersonAssociate_ResidentialAddress_AddressLine3">Address line 3</label>
        </div>
        <div class="col8 last">
            <input id="Associates_PersonAssociate_ResidentialAddress_AddressLine3" name="Associates.PersonAssociate.ResidentialAddress.AddressLine3" type="text" value=""> 
    ...
    <div class="grid-row address-australian" style="display: none">
        <div class="col4">
            <label class="input-right" for="Associates_PersonAssociate_ResidentialAddress_Suburb">Suburb</label>
        </div>
        <div class="col8 last">
            <input class="capitalize" id="Associates_PersonAssociate_ResidentialAddress_Suburb" name="Associates.PersonAssociate.ResidentialAddress.Suburb" type="text" value=""> 
