...
<option value="6">Review Required</option>
	...
	<tfoot>
		...
		<tr onclick="toggleRow(this);">
			<td>&nbsp;</td>
			<td colspan="2"><strong>Trade marks</strong></td>
			<td><span class="fa fa-plus-square">&nbsp;</span></td>
		</tr>
		<tr class="hidden-row visuallyhidden">
			<td>&nbsp;</td>
			<td colspan="2">
				<p>If you want to distinguish your goods, services (or both) from those of another business, you may need a trade mark. To find out what trade marks are and what’s involved in the application and management process, visit the <a href="https://www.ipaustralia.gov.au/trade-marks" target="_blank">IP-Australia website</a>.</p></td>
			<td>&nbsp;</td>
		</tr>
		<tr onclick="toggleRow(this);">
			<td>&nbsp;</td>
			<td colspan="2"><strong>AUSTRAC</strong></td>
			<td><span class="fa fa-plus-square">&nbsp;</span></td>
		</tr>
		<tr class="hidden-row visuallyhidden">
			<td>&nbsp;</td>
			<td colspan="2"><p>Your chosen Business Activity indicates you may need to be enrolled and/or registered with AUSTRAC. To find out more about these mandatory requirements, please visit the <a href="http://www.austrac.gov.au/businesses/enrolment-and-remitter-registration/enrolment-and-registration" target="_blank">AUSTRAC website</a>.</p></td>
			<td>&nbsp;</td>
		</tr>
	</tfoot>
    </table>
